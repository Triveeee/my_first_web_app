...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\UTENTE\Desktop\EserciziDos\Linguaggi\python\my_first_web_app\env4'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\UTENTE\Desktop\EserciziDos\Linguaggi\python\my_first_web_app\env4\Scripts\deactivate.nu'
